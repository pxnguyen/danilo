...
opts.subtractAverage = [] ; % mean subtraction

opts.jitterFlip = false ;
opts.jitterLocation = false ;
opts.jitterAspect = 1 ;
opts.jitterScale = 1 ;
opts.jitterBrightness = 0 ; % random color shift
opts.jitterContrast = 0 ; % random changes in contrast
opts.jitterSaturation = 0 ; % random changes in saturation
